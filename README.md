...
- [Credit Cards](https://github.com/Wildhoney/Equigraph/tree/main/src/queries/credit_cards)
...
* [`ZEROES`](https://github.com/Wildhoney/Equigraph/blob/main/src/objects/input.rs#L22-L25)
* [`UNIQUE`](https://github.com/Wildhoney/Equigraph/blob/main/src/objects/input.rs#L29-L32)
* [`ACTIVE`](https://github.com/Wildhoney/Equigraph/blob/main/src/objects/input.rs#L37-L40)
